...
/**
 * @struct MNT
 * @brief Digital Terrain Model (DTM or MNT in French) composed of:
...
{
    /**
     * @brief Details about attributes:
...
/**
 * @fn convert_data_to_pixels_delaunay
...
/**
 * @fn associate_triangle_summits_to_pixels
